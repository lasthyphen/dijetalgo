...
var (
	...
	PrevMinimumCompatibleVersion = NewDefaultApplication(constants.PlatformName, 1, 7, 0)
	...
	ApricotPhase1Times = map[uint32]time.Time{
		...
		constants.TahoeID:    time.Date(2021, time.March, 26, 14, 0, 0, 0, time.UTC),
	}
	...
	ApricotPhase2Times = map[uint32]time.Time{
		...
		constants.TahoeID:    time.Date(2021, time.May, 5, 14, 0, 0, 0, time.UTC),
	}
	ApricotPhase2DefaultTime = time.Date(2020, time.December, 5, 5, 0, 0, 0, time.UTC)

	ApricotPhase3Times = map[uint32]time.Time{
		constants.MainnetID: time.Date(2021, time.August, 24, 14, 0, 0, 0, time.UTC),
		constants.TahoeID:    time.Date(2021, time.August, 16, 19, 0, 0, 0, time.UTC),
	}
