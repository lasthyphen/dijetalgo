...
```sh
go get -v -d github.com/lasthyphen/dijetalgo/...
cd $GOPATH/src/github.com/lasthyphen/dijetalgo
```
...
Download the [latest build](https://github.com/lasthyphen/dijetalgo/releases/latest) for your operating system and architecture.
